...
public class BookNowPage extends JFrame {
        ...
        btnNext.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    System.out.println("from book now page sent the customerid "+customerId);
    ...
    private void loadTheaters() {
        ...
        try (Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3306/mini2", "root", "snehal2005")) {
