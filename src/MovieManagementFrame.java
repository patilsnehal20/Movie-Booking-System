...
//code to insert ,update, delete, display the movies.
package movie_1;
import javax.swing.*;
import java.awt.*;
...
public class MovieManagementFrame extends JFrame {
  ...
  private final String dbURL = "jdbc:mysql://localhost:3306/mini2";
  private final String dbUser = "root";
  private final String dbPassword = "snehal2005";
  ...
  public MovieManagementFrame() {
   ...
   // Back button to return to admin dashboard
      ...
      backButton.addActionListener(e -> {
          ...
          new AdminDashboard(); // Call your AdminDashboard frame (replace with actual class)
      });
